...
import 'package:neclicensepreperation/features/main/presentation/pages/topics/DSA/learn_toc.dart';
import 'package:neclicensepreperation/features/main/widgets/floating_btn.dart';
import 'package:neclicensepreperation/features/main/widgets/option_button.dart';

class Dsa extends StatefulWidget {
  static route() => MaterialPageRoute(
        builder: (context) => const Dsa(),
      );
  const Dsa({super.key});
...
class _DsaState extends State<Dsa> {
  ...
  void initState() {
    super.initState();
    context.read<QuestionBloc>().add(QuestionFetchDsaQuestions());
  }
